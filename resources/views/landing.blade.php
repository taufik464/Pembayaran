...
<body class="bg-white text-gray-800">
    ...
    <!-- Hero Section -->
    <section id="beranda" class="bg-cover bg-center bg-no-repeat text-white py-24 relative"
        style="background-image: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('https://images.unsplash.com/photo-1523050854058-8df90110c9f1?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80');">
        <div class="relative z-10 max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center">
            <div class="w-full md:w-1/2 mb-10 md:mb-0">
                <div class="bg-white/30 backdrop-blur-lg rounded-xl p-6 md:p-10 shadow-lg">
                    ...
                    <p class="text-lg text-white mb-6">Sekolah Islam Modern yang Membentuk Generasi Cerdas, Islami, dan
                        Mandiri</p>
                    <a href="#tentang"
                        class="bg-yellow-400 hover:bg-yellow-300 text-black px-6 py-3 rounded-full font-semibold transition">Pelajari
                        Lebih Lanjut</a>
                </div>
            </div>
        </div>
            ...
            <div class="flex flex-col md:flex-row items-center md:items-start md:space-x-8">
                ...
                <div class="w-full md:w-2/3">
                    <p class="text-lg leading-relaxed text-justify">
                        ...
                        ultricies, nunc nisl aliquet nunc, quis aliquam nisl nunc eu nisl. Sed euismod, nisl eget
                        aliquam ultricies, nunc nisl aliquet nunc, quis aliquam nisl nunc eu nisl.

                        Vivamus auctor, nisl eget aliquam ultricies, nunc nisl aliquet nunc, quis aliquam nisl nunc eu
                        nisl. Sed euismod, nisl eget aliquam ultricies, nunc nisl aliquet nunc, quis aliquam nisl nunc
                        eu nisl.

                        Phasellus euismod, nisl eget aliquam ultricies, nunc nisl aliquet nunc, quis aliquam nisl nunc
                        eu nisl. Sed euismod, nisl eget aliquam ultricies, nunc nisl aliquet nunc, quis aliquam nisl
                        nunc eu nisl. </p>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-6xl mx-auto px-6">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition">
                    ...
                    <p class="text-gray-600">Program pembentukan karakter Islami melalui pembiasaan ibadah harian dan
                        akhlak mulia.</p>
                </div>
                <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition">
                    <img src="" class="w-16 mb-4" alt="">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition">
                    ...
                    <p class="text-gray-600">Pembelajaran berkualitas, bimbingan UTBK dan olimpiade sains untuk prestasi
                        akademik.</p>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-6xl mx-auto px-6">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition">
                    ...
                    <p class="text-gray-600">Kegiatan kepramukaan yang melatih kemandirian, kerja sama, dan kepemimpinan
                        siswa.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition">
                    ...
                    <p class="text-gray-600">Latihan baris-berbaris dan kedisiplinan untuk upacara serta lomba antar
                        sekolah.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition">
                    ...
                    <p class="text-gray-600">Klub bahasa Inggris untuk meningkatkan kemampuan speaking, writing, dan
                        grammar siswa.</p>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-xl shadow p-6">
                    ...
                    <p class="text-sm text-gray-600">Siswa kelas 12 mengikuti kunjungan edukatif ke PT Telkom guna
                        memahami dunia kerja dan teknologi.</p>
                </div>
                ...
                <div class="bg-white rounded-xl shadow p-6">
                    ...
                    <p class="text-sm text-gray-600">Santri SMA Al Hikmah berhasil meraih juara dalam lomba tahfidz
                        tingkat kabupaten.</p>
                </div>
                ...
                <div class="bg-white rounded-xl shadow p-6">
                    ...
                    <p class="text-sm text-gray-600">Kegiatan Maulid Nabi diisi dengan ceramah dan pentas seni Islami
                        oleh siswa-siswi SMA Al Hikmah.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <footer class="bg-gray-900 text-white pt-16 pb-8">
        ...
        <div class="border-t border-gray-700 mt-10 pt-6">
            ...
            <div class="flex justify-center space-x-4 mb-4">
                <a href="#"
                    class="w-8 h-8 flex items-center justify-center border border-white rounded-full hover:bg-white hover:text-gray-900 transition">
