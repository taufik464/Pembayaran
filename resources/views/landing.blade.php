...
<head>
  ...
  <!-- Hanya gunakan satu versi Font Awesome -->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
  <style>
    body {
      font-family: 'Inter', sans-serif;
    }
    /* Menambahkan efek hover yang lebih baik untuk social icons */
    .social-icon {
...
<body class="bg-white text-gray-800">
 ...
 <!-- Navbar -->
  <header class="bg-white shadow sticky top-0 z-50">
    <div class="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
      <div class="flex items-center space-x-3">
        ...
        <div class="w-10 h-10 bg-green-700 rounded-full flex items-center justify-center text-white font-bold">AH</div>
  ...
  <!-- Hero Section -->
<section id="beranda" class="bg-cover bg-center bg-no-repeat text-white py-24 relative" style="background-image: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('https://images.unsplash.com/photo-1523050854058-8df90110c9f1?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80');">
...
<section id="profil" class="py-16 bg-gray-100">
    ...
    <div class="w-32 h-32 md:w-40 md:h-40 overflow-hidden rounded-full shadow-lg bg-gray-300 flex items-center justify-center">
    ...
    <div class="grid md:grid-cols-3 gap-8">
      ...
      <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition">
        <div class="w-16 h-16 bg-orange-100 rounded-full flex items-center justify-center mb-4">
          <i class="fas fa-campground text-orange-600 text-2xl"></i>
        </div>
  ...
  <div class="max-w-7xl mx-auto px-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
      ...
      <div class="bg-white rounded-xl shadow p-6">
        <div class="mb-4 rounded-lg w-full h-40 bg-gray-300 flex items-center justify-center">
...
<footer class="bg-gray-900 text-white pt-16 pb-8">
  <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-5 gap-8 text-sm text-gray-300">
    <!-- Logo -->
    <div>
      <div class="w-10 h-10 bg-green-700 rounded-full flex items-center justify-center text-white font-bold mb-2">AH</div>
      <p>SMA AL HIKMAH</p>
      <p class="mt-2">Mencetak generasi berakhlak mulia dan berprestasi</p>
    </div>

    <!-- Column 1 -->
    <div>
      <h3 class="font-semibold text-white mb-2">Program Sekolah</h3>
      <ul>
        <li><a href="#" class="hover:text-white">Kurikulum</a></li>
        <li><a href="#" class="hover:text-white">Ekstrakurikuler</a></li>
        <li><a href="#" class="hover:text-white">Program Tahfidz</a></li>
      </ul>
    </div>

    <!-- Column 2 -->
    <div>
      <h3 class="font-semibold text-white mb-2">Informasi</h3>
      <ul>
    ...
    <!-- Column 3 -->
    <div>
      <h3 class="font-semibold text-white mb-2">Fasilitas</h3>
      <ul>
        <li><a href="#" class="hover:text-white">Perpustakaan</a></li>
        <li><a href="#" class="hover:text-white">Laboratorium</a></li>
        <li><a href="#" class="hover:text-white">Masjid</a></li>
      </ul>
    </div>

    <!-- Column 4 -->
    <div>
      <h3 class="font-semibold text-white mb-2">Kontak Kami</h3>
      <ul>
        <li><i class="fas fa-map-marker-alt mr-2"></i> Jl. Pendidikan No. 123</li>
        <li><i class="fas fa-phone mr-2"></i> (021) 1234567</li>
        <li><i class="fas fa-envelope mr-2"></i> info@smaalhikmah.sch.id</li>
      </ul>
    </div>
  </div>

  <div class="border-t border-gray-700 mt-10 pt-6">
    <!-- Social Icons - Diperbaiki -->
    <div class="flex justify-center space-x-4 mb-4">
      <a href="https://www.facebook.com/smaalhikmahmuncar" target="_blank" rel="noopener noreferrer" class="social-icon w-10 h-10 flex items-center justify-center border border-white rounded-full hover:bg-white hover:text-blue-600 transition">
        <i class="fab fa-facebook-f"></i>
      </a>
      <a href="https://www.instagram.com/smaalhikmahmuncar?igsh=dDA3b2hneGtudXB5" target="_blank" rel="noopener noreferrer" class="social-icon w-10 h-10 flex items-center justify-center border border-white rounded-full hover:bg-white hover:text-pink-500 transition">
        <i class="fab fa-instagram"></i>
      </a>
      <a href="https://www.youtube.com/@bilhikmah" target="_blank" rel="noopener noreferrer" class="social-icon w-10 h-10 flex items-center justify-center border border-white rounded-full hover:bg-white hover:text-red-600 transition">
