...
<section class=" bg-white mt-6 p-6 rounded-lg shadow">
    <form action="{{ route('admin.alumni.store') }}" method="POST" enctype="multipart/form-data"
        ...
        <div class="mb-4">
            <label for="tahun_lulus" class="block text-gray-700 font-bold mb-2">Tahun Lulus:</label>
        ...
        <div class="mb-4">
            <label for="tempat_kuliah" class="block text
-gray-700 font-bold mb-2">Tempat Kuliah:</label>
